...

{
  ...
  build_job_steps => [
    ...
    ### NEXT STEP ###########################
    {
        ...
        #url        => 'https://cpan.metacpan.org/authors/id/X/XS/XSAWYERX/perl-5.32.0.tar.gz',
    ...
    ### NEXT STEP ###########################
    {
        ...
        modules => [
            #{ module=>'App::cpanminus', skiptest=>1 },
			{ module=>'Portable', skiptest=>1 }, 
            { module=>'JSON', skiptest=>1 },
            { module=>'JSON::XS', skiptest=>1 },
            { module=>'Win32', skiptest=>1 },
            { module=>'Win32::Unicode', skiptest=>1 },
            { module=>'LWP', skiptest=>1 },
            { module=>'LWP::Protocol::https', skiptest=>1 },
            { module=>'XML::LibXML', skiptest=>1 },
            { module=>'Mojolicious', skiptest=>1 },
            { module=>'CGI', skiptest=>1 },
        ],
    },
    ### NEXT STEP ###########################
    {
